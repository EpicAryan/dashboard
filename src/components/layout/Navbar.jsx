...
const Navbar = ({ onMenuClick }) => {
  ...
  // Use modal hooks for both modals
  const searchModal = useModalState(false, { trapFocus: true })
  const profileModal = useModalState(false, { trapFocus: true })
  ...
  return (
    <>
      ...
      {/* Modals using the hook */}
      <SearchDialog {...searchModal.modalProps} />
